...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'question.create': {
    roles: ['management-representative', 'company-owner'],
    key: 'new-question-submitted',
    tenantPath: ['organization', 'question'],
    userPath: [],
  },
  'answer.create': {
    roles: ['business-analyst', 'company-owner'],
    key: 'new-answer-provided',
    tenantPath: ['organization', 'question', 'answer'],
    userPath: [],
  },
  'video.create': {
    roles: ['guest', 'business-analyst', 'company-owner'],
    key: 'new-video-uploaded',
    tenantPath: ['organization', 'video'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['management-representative'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['company-owner', 'management-representative', 'business-analyst'];
